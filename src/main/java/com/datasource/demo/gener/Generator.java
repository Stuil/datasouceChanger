package com.datasource.demo.gener;
...
public class Generator {
    ...
    // 包名
    private static final String packageName = "com.datasource.demo";
    private static final String moduleName = "";
    private static final String[] tableName = ("consumer").split(",");
    ...
    private static DataSourceConfig getDataSourceConfig() {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/mydb1?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC&useSSL=false");
    ...
    private static PackageConfig getPackageConfig() {
        ...
        pc.setParent("com.datasource.demo");
